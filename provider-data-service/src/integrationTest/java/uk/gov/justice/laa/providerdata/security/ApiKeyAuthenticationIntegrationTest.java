...
class ApiKeyAuthenticationIntegrationTest {
  ...
  @Test
  void protectedEndpointWithoutApiKeyReturnsUnauthorized() throws Exception {
    mockMvc
        .perform(get("/trace/1"))
  ...
  @Test
  void protectedEndpointWithInvalidApiKeyReturnsUnauthorized() throws Exception {
    mockMvc
  ...
  @Test
  void protectedEndpointWithValidKeyButUnauthorisedRoleReturnsForbidden() throws Exception {
    mockMvc
