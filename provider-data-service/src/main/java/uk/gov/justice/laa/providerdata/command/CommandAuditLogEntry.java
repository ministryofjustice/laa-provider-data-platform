 ...
 * uk.gov.justice.laa.providerdata.entity.CommandAuditLogEntity} — it does not expose JPA
 * audit columns (createdBy, version, etc.) which are internal implementation details.
 */
