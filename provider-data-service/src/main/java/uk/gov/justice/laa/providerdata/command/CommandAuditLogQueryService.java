 ...
 *
 * <p>Provides read-only access to audit records written by {@link
 * uk.gov.justice.laa.providerdata.command.event.CommandAuditEventListener}. Implementing classes
