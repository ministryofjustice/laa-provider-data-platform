...
public class ProviderQueryService {
   ...
   * Inject dependencies.
   *
   * @param providerRepository to query provider entities.
   * @param lspProviderOfficeLinkRepository to query LSP office links.
   * @param chamberProviderOfficeLinkRepository to query Chambers office links.
   * @param advocateProviderOfficeLinkRepository to query Advocate office links.
   * @param providerParentLinkRepository to query provider parent links.
   * @param providerFirmRepository to search provider firms with specifications.
   */
