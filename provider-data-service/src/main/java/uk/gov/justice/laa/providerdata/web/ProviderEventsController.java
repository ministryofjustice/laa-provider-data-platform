...
import uk.gov.justice.laa.providerdata.event.ProviderEventQueryService;
 ...
 *
 * <p>The list endpoint returns event headers only. The single-event endpoint deserialises the
 * stored JSON payload and returns the full {@link EventV2}.
 */
@RestController
