...
class ProviderFirmOfficesLiaisonManagersControllerTest {
  ...
  @MockitoBean private OfficeLiaisonManagerQueryService officeLiaisonManagerQueryService;
  ...
  void getOfficeLiaisonManagers_returns200_withPaginationMetadata() throws Exception {
    ...
    when(officeLiaisonManagerQueryService.getOfficeLiaisonManagers(
            "100001", "ACC001", PageRequest.of(0, 100)))
    ...
    verify(officeLiaisonManagerQueryService)
        .getOfficeLiaisonManagers("100001", "ACC001", PageRequest.of(0, 100));
  }

  @Test
  void getOfficeLiaisonManagers_returns404_whenServiceThrowsNotFound() throws Exception {
    when(officeLiaisonManagerQueryService.getOfficeLiaisonManagers(
            "999404", "ACC404", PageRequest.of(0, 100)))
    ...
    verify(officeLiaisonManagerQueryService)
        .getOfficeLiaisonManagers("999404", "ACC404", PageRequest.of(0, 100));
  }
